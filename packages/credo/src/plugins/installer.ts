...
export async function installCredoJS() {
	...
	const notEmpty = [".credo", "dev", "build"];
	const directories = [".credo", "dev", "build", "config", "lexicon", "src-client", "src-server", "src-full"];
	...
	await docTypeReference(["@credo-js/server", "@credo-js/types"]);
