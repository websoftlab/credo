...
export default class HtmlDocument {
	...
	get doctype(): string { return drv(this).doctype; }
	get title(): string { return drv(this).title; }
	get language(): string | null { return drv(this).language; }
	get charset(): string | null { return drv(this).charset; }
	get htmlAttributes(): any { return drv(this).htmlAttributes; }
	get noscriptBanner(): string | null { return drv(this).noscriptBanner; }
	get getQueryId(): string { return drv(this).getQueryId; }
	get ssr(): boolean { return drv(this).ssr; }
	get baseUrl(): string { return drv(this).baseUrl; }
	get scripts(): string[] { return drv(this).scripts; }
	get styles(): string[] { return drv(this).styles; }

	set doctype(value: string) { drv(this).doctype = value; }
	set title(value: string) { drv(this).title = value; }
	set language(value: string | null) { drv(this).language = value; }
	set charset(value: string | null) { drv(this).charset = value; }
	set htmlAttributes(value: any) { drv(this).htmlAttributes = value; }
	set noscriptBanner(value: string | null) { drv(this).noscriptBanner = value; }
	set getQueryId(value: string) { drv(this).getQueryId = value; }
	set ssr(value: boolean) { drv(this).ssr = value; }
	set baseUrl(value: string) { drv(this).baseUrl = value; }
	set scripts(value: string[]) { drv(this).scripts = value; }
