...
export type ResponderPageResult = ResponderPageResultFound | ResponderPageResultNotFound | ResponderPageResultRedirect;
...
export interface OnPageHTMLBeforeRenderHook extends CtxHook {
